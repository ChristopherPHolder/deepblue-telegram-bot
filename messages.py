...
NO_ACTIVE_CD_MSG = 'Sorry there are no active countdowns.'

NO_CD_TO_DEL = 'Sorry there are no countdowns to delete'

NO_CD_TO_PRE = 'Sorry, there are no countdowns to preview.'

NO_CD_TO_SET = 'Sorry there are currently no countdowns'
